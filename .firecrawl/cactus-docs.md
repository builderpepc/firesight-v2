[Skip to content](https://docs.cactuscompute.com/latest/#quick-demo-mac)
...
Table of contents
  ...
  - [Quick Demo (Mac)](https://docs.cactuscompute.com/latest/#quick-demo-mac)
  - [Cactus Engine](https://docs.cactuscompute.com/latest/#cactus-engine)
  - [Cactus Graph](https://docs.cactuscompute.com/latest/#cactus-graph)
  - [API & SDK References](https://docs.cactuscompute.com/latest/#api-sdk-references)
  - [Benchmarks (CPU-only, no GPU)](https://docs.cactuscompute.com/latest/#benchmarks-cpu-only-no-gpu)
  - [Supported Transcription Model](https://docs.cactuscompute.com/latest/#supported-transcription-model)
  - [Supported LLMs](https://docs.cactuscompute.com/latest/#supported-llms)
  - [Roadmap](https://docs.cactuscompute.com/latest/#roadmap)
  - [Using this repo](https://docs.cactuscompute.com/latest/#using-this-repo)
  - [Maintaining Organisations](https://docs.cactuscompute.com/latest/#maintaining-organisations)
  - [Citation](https://docs.cactuscompute.com/latest/#citation)
...
![Logo](https://docs.cactuscompute.com/latest/assets/banner.jpg)
...
## Quick Demo (Mac) [¶](https://docs.cactuscompute.com/latest/\#quick-demo-mac "Permanent link")

- Step 1: `brew install cactus-compute/cactus/cactus`
- Step 2: `cactus transcribe` or `cactus run`

## Cactus Engine [¶](https://docs.cactuscompute.com/latest/\#cactus-engine "Permanent link")
...
## Cactus Graph [¶](https://docs.cactuscompute.com/latest/\#cactus-graph "Permanent link")
...
## API & SDK References [¶](https://docs.cactuscompute.com/latest/\#api-sdk-references "Permanent link")

| Reference | Language | Description |
| --- | --- | --- |
| [Engine API](https://docs.cactuscompute.com/latest/docs/cactus_engine/) | C | Chat completion, streaming, tool calling, transcription, embeddings, RAG, vision, VAD, vector index, cloud handoff |
| [Graph API](https://docs.cactuscompute.com/latest/docs/cactus_graph/) | C++ | Tensor operations, matrix multiplication, attention, normalization, activation functions |
| [Python SDK](https://docs.cactuscompute.com/latest/python/) | Python | Mac, Linux |
| [Swift SDK](https://docs.cactuscompute.com/latest/apple/) | Swift | iOS, macOS, tvOS, watchOS, Android |
| [Kotlin SDK](https://docs.cactuscompute.com/latest/android/) | Kotlin | Android, iOS (via KMP) |
| [Flutter SDK](https://docs.cactuscompute.com/latest/flutter/) | Dart | iOS, macOS, Android |
| [Rust SDK](https://docs.cactuscompute.com/latest/rust/) | Rust | Mac, Linux |
...
## Benchmarks (CPU-only, no GPU) [¶](https://docs.cactuscompute.com/latest/\#benchmarks-cpu-only-no-gpu "Permanent link")
...
## Supported Transcription Model [¶](https://docs.cactuscompute.com/latest/\#supported-transcription-model "Permanent link")
...
## Supported LLMs [¶](https://docs.cactuscompute.com/latest/\#supported-llms "Permanent link")
...
## Roadmap [¶](https://docs.cactuscompute.com/latest/\#roadmap "Permanent link")
...
## Using this repo [¶](https://docs.cactuscompute.com/latest/\#using-this-repo "Permanent link")
...
## Maintaining Organisations [¶](https://docs.cactuscompute.com/latest/\#maintaining-organisations "Permanent link")
...
## Citation [¶](https://docs.cactuscompute.com/latest/\#citation "Permanent link")
